...
18,000+ scenarios across 100+ staged files exercise the verification pipeline's 26 gates. **~2,800 core scenarios** (ALL CLEAN as of April 5, 2026 — 0 dirty). **~2,400 aspirational scenarios** (tagged, excluded from default runs). Plus supply chain, real-world harvesters, and WPT corpus. 611/647 failure shapes covered (94%). 100 generator scripts produce synthetic scenarios; 7 harvesters fetch real-world data from SchemaPile, MDN, Can I Use, PostCSS, Mustache spec, JSON Schema Test Suite, PayloadsAllTheThings, and Heroku. 354 unit tests with 21,342 assertions, 0 failures.
